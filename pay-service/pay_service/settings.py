...
SECRET_KEY = os.environ.get('SECRET_KEY', 'pay_service-dev-secret-2024')
...
DATABASES = {
    'default': {
        ...
        'NAME':     os.environ.get('DB_NAME', 'bookstore_micro_payment'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Payment Service - Thanh toan',
    'DESCRIPTION': 'Quan ly giao dich thanh toan',
    'VERSION': '1.0.0',
}
