...
SECRET_KEY = os.environ.get('SECRET_KEY', 'comment_service-dev-secret-2024')
...
DATABASES = {
    'default': {
        ...
        'NAME':     os.environ.get('DB_NAME', 'bookstore_micro_rating'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Comment Service - Danh gia',
    'DESCRIPTION': 'Quan ly danh gia va binh luan sach',
    'VERSION': '1.0.0',
}
